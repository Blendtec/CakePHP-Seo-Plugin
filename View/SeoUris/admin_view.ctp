	...
	<div class="span3">
        <div class="widget no-margin">
            ...
            <div class="widget-body">
                <ul>
                    <li><?php echo $this->Html->link(__('List Uris'), array('action' => 'index')); ?> </li>
                    <li><?php echo $this->Html->link(__('Edit Uri'), array('action' => 'edit', $seoUri['SeoUri']['id'])); ?> </li>
                    <li><?php echo $this->Html->link(__('Delete Uri'), array('action' => 'delete', $seoUri['SeoUri']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $seoUri['SeoUri']['id'])); ?> </li>
                </ul>
            </div>
        </div>
    </div>
